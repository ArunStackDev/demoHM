...
function AboutMeetTeam({ linkedinUrl, name, designation, imageSrc }) {
  ...
  return (
    <article className="h-80 w-46 rounded-full mt-6 bg-[#E0E0E0] flex flex-col items-center max-md:h-72 max-md:w-42 max-sm:h-64 max-sm:w-36">
      {/* Member photo and name */}
      <header className="flex flex-col items-center">
        <img
          src={ImageSrc}
          alt="Team member Profile picture"
          className="object-cover w-36 h-36 mt-4 max-md:w-32 max-md:h-32 max-sm:w-28 max-sm:h-28"
